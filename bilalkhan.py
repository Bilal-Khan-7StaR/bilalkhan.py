...
#The Credit For This Code Goes To Muhammad Bilal Khan 7StaR group
...
`·.|.·´__.·´ .·´`·.|.·´`·.|·´`·.¸||______|/\||_'|/   |__|/ 
   ...
   |___'|.·´    7 StaR GrouP D I KhaN    -«

\033[1;97m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94m7StaR group\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•
...
\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\ 7 StaR GrouP D I KhaN \033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
...
7StaR("\033[1;96m---------------------(___)_________")

7StaR("\033[1;96m--------\_____/\__/----\__/\_____/")

7StaR("\033[1;96m------------\ _°_[------------]_ _° /")

7StaR("\033[1;96m----------------\_°_¤ ---- ¤_°_/")

7StaR("\033[1;96m--------------------\ __°__ /")
...
7StaR('\033[1;93m             WeLcoMe To 7 StaR GrouP')

print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\ All faCeBooK MasTeR
...
CorrectUsername = "Bilal-Khan-7StaR"

CorrectPassword = "BilalHacKeR123"

loop = 'true'

while (loop == 'true'):

    username = raw_input("\033[1;97m📋 \x1b[1;96mTool Username \ Bilal-Khan-7StaR )

    if (username == CorrectUsername):

    	password = raw_input("\033[1;97m🗝 \x1b[1;96mTool Password \ BilalHacKeR123)

        if (password == CorrectPassword):

            print "Logged in successfully as " + username # Bilal-Khan-7StaR
	    ...
	    time.sleep(2)
           ...
           Facebook Muhammad Bilal Khan)

    else:

        print "\033[1;96mWrong Username"

       WhatsApp 03467314338 )
...
def login():
	...
	try:
		...
		7StaR(' \033[1;93mWarning: \033[1;96mDo Not Use Your Personal Account' )

		7StaR(' \033[1;93mWarning: \033[1;96mUse a New Account To Login' )

		7StaR(' \033[1;93mWarning: \033[1;96mTermux  All version Work✅' )                 

		7StaR("\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;937StaR group D I KhaN\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

		7StaR('	   \033[1;97m▬\x1b[1;94m.........LOGIN WITH FACEBOOK........\x1b[1;97m▬' )
...
def menu():
	...
	os.system("clear") #Dev: Bilal-Khan-7StaR
	...
	print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;93m7StaR group\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;937StaR group D I KhaN\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"

		7StaR('\033[1;94mGetting IDs \033[1;94m...')

		r =  Facebook. Muhammad Bilal Khan)
	...
	7StaR('\033[1;94mPlease Wait\033[1;94m...')

	titik = ['.   ','..  ','... ']

	for o in titik:bilalgandapur4
	...
	7StaR(' \033[1;97m.................\033[1;93mCloning Start..\033[1;97m............ ')
	...
	def main(arg):
		...
		try:
			...
			pass #Dev: Bilal-Khan-7StaR

		try:

			a = requests.get(https://www.facebook.com/7Star-Group-Dikhan-100489428155686/)
